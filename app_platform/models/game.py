...
from app_platform.utils import (
...
class GameQuerySet(models.QuerySet):
    def get_month_games(self):
        ...
        return self.filter(game_day__month=next_wedsnesday.month,
    ...
    def get_next_game(self):
        next_wednesday = get_next_wednesday_date()
        return self.filter(game_day__day=next_wednesday.day,game_day__month=next_wednesday.month,game_day__year=next_wednesday.year)
